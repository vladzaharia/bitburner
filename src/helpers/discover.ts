...
export async function main(ns: NS) {
    ...
    const allHosts = Discover.getHosts(ns, depth);
    Discover.getCrackableHosts(ns, allHosts, depth);
    return allHosts;
}

export module Discover {
    /** 
    ...
    function canCrack(ns: NS, hostname: string): boolean {
        ...
        const numPorts = Crack.getPortOpeners(ns).length;
